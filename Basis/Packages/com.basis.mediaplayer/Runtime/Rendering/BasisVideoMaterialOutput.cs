...
namespace Basis.Media
{
    ...
    public sealed class BasisVideoMaterialOutput : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (Player == null)
            {
                Debug.LogWarning("[BasisMedia] BasisVideoMaterialOutput: no BasisMediaPlayer found in parents and Player field is empty.");
                return;
            }
            ...
            {
                Debug.LogWarning("[BasisMedia] BasisVideoMaterialOutput: no target renderers assigned; cannot bind the video texture.");
                return;
            }
